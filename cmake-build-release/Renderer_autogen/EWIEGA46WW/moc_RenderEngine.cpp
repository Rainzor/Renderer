...
QT_MOC_LITERAL(3, 29, 8) // "progress"
    ...
    "RenderEngine\0updateProgress\0\0progress"
};
...
void RenderEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (RenderEngine::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RenderEngine::updateProgress)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RenderEngine::updateProgress(int _t1)
{
